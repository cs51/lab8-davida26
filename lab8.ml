...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let i = new_id () in evt := {id=i; action=listener} :: (!evt); i
...
......................................................................*)
  ...
  let fire_event (evt : 'a event) (arg : 'a) : unit =
    let waiters = !evt in List.iter (fun w -> w.action arg) waiters
...
let receive_report (st : string) : unit = 
  let _ = WEvent.add_listener publish (fun () -> fakeNewsNetwork st) in
  let _ = WEvent.add_listener publish (fun () -> buzzFake st) in ()
